...
{
    /// <inheritdoc />
    public partial class Home_Work_Sumo2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductExtend_Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductExtend_Weig = table.Column<double>(type: "float", nullable: true),
